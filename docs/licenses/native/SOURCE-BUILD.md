...
- macOS: `app.asar.unpacked/node_modules/@img/sharp-libvips-darwin-{x64|arm64}/lib/`
  under `Conteenua Companion.app/Contents/Resources`.
...
```sh
codesign --force --deep --sign - "Conteenua Companion.app"
codesign --verify --deep --strict --verbose=2 "Conteenua Companion.app"
```
