...
the text incorporated by LGPLv3; it does not relicense Conteenua Companion as GPL software.
...
places `Conteenua-Companion-Native-Sources.tar.gz` beside the matching installers at:
https://github.com/EnmanuelSoto/conteenua-companion/releases
...
(including its DEPS file). OpenAI tunnel-client, Cloudflare cloudflared, and ripgrep retain
their own notices; cloudflared 2026.9.1's Apache-2.0 text is preserved in
`docs/licenses/cloudflared-LICENSE` and the generated `THIRD-PARTY-NOTICES.txt`.
