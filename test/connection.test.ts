...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    publication: vi.fn((surface: string, observe: (name: string, version: string, instructions: string, tools: unknown[]) => void) => observe(`Conteenua Companion ${surface}`, '1', 'instructions', [])),
