...
const app = process.argv[3]
  ...
  : path.join(releaseDir, unpackedDir, 'Conteenua Companion.app');
...
const expectedPlist = {
  ...
  NSScreenCaptureUsageDescription:
    'Conteenua Companion captures a display or window only when the enabled Desktop connector asks to observe it.'
};
...
const mainExecutable = path.join(contents, 'MacOS', 'Conteenua Companion');
