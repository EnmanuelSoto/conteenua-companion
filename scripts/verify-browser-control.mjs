...
await fs.writeFile(path.join(extension,'manifest.json'),JSON.stringify({manifest_version:3,name:'Conteenua Companion isolated browser fixture',version:'1.0.0',permissions:['debugger','tabs','storage','scripting'],host_permissions:[`${base}/*`,`http://localhost:${port}/*`],background:{service_worker:'fixture.js',type:'module'}}));
