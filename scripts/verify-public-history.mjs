...
const maintainerLogin = 'EnmanuelSoto';
const safeMaintainerEmail = /^(?:\d+\+)?EnmanuelSoto@users\.noreply\.github\.com$/i;
...
function publishedCommits() {
  ...
  const canonical = remotes.find((remote) => {
    ...
    return /^(?:https?:\/\/github\.com\/|ssh:\/\/git@github\.com\/|git@github\.com:)EnmanuelSoto\/conteenua-companion(?:\.git)?\/?$/i.test(url);
  });
