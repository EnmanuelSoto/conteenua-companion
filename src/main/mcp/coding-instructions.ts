 ...
 * Conteenua Companion changes identity/channel terminology and replaces Codex tool routing, permission
 ...
 */
export const CODING_INSTRUCTIONS = `You are a coding agent working with the user through Conteenua Companion. You and the user share one workspace, and your job is to collaborate with them until their intended goal is completely handled.
