 ...
 */
export const CONNECTOR_BRAND = 'Conteenua Companion';
...
const CORE: SurfaceDefinition = {
  id: 'core',
  serverName: 'conteenua-companion-core',
...
const DESKTOP: SurfaceDefinition = {
  id: 'desktop',
  serverName: 'conteenua-companion-desktop',
...
const PLUGINS: SurfaceDefinition = {
  id: 'plugins', serverName: 'conteenua-companion-plugins',
  connectorName: `${CONNECTOR_BRAND} Plugins`,
  description: 'Tools from external MCP integrations installed and enabled in Conteenua Companion Settings, including Blender and other connected applications and services.',
