 ...
 * the same prefix: `/project/conteenua-companion/src/main/patch.ts` where `src/main/patch.ts`
 ...
 *
 * The workspace learned from `/project/conteenua-companion/src/main/patch.ts` should be the
...
export interface Workspace {
  /** Virtual path of the folder, e.g. `/project/conteenua-companion`. */
  virtual: string;
  real: string;
  at: number;
}
